...
\begin{document}
	...
	\begin{figure}
		...
		\begin{subfigure}{0.46\linewidth}  % Subfigure environment for the first image
			\includegraphics[width=\linewidth]{car1.jpeg}  % Include image1.jpg
			\caption{Porsche 911 gt3rs}  % Caption for the first image
		...
		\begin{subfigure}{0.44\linewidth}  % Subfigure environment for the second image
			\includegraphics[width=\linewidth]{car3.jpeg}  % Include image2.png
			\caption{Mclaren MP-4 12C }  % Caption for the second image
